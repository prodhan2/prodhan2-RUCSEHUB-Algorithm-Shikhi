...
export const algorithms = [
    ...
    },
    {
        ...
        name: 'Stack Array',
        category: 'Data Structures',
        meta: 'Visualize stack behavior with push and pop operations using a simple array-based stack.',
        meta_bn: 'push ও pop অপারেশন ব্যবহার করে array-based stack কিভাবে কাজ করে তা visualভাবে দেখুন।',
    },
    {
        id: 'QueueArray',
        name: 'Queue Array',
        category: 'Data Structures',
        meta: 'Visualize a simple FIFO queue using an array with front and rear operations.',
        meta_bn: 'front ও rear অপারেশনসহ একটি সাধারণ FIFO queue কিভাবে কাজ করে তা visualভাবে দেখুন।',
    },
    {
        id: 'LinkedList',
        name: 'Linked List',
        category: 'Data Structures',
        meta: 'Explore how nodes connect through pointers in a singly linked list with insertion and deletion steps.',
        meta_bn: 'pointer-এর মাধ্যমে node যুক্ত হয়ে singly linked list কীভাবে insertion ও deletion দেখায় তা শিখুন।',
    },
    {
        id: 'KMap',
        name: 'K-Map Visualizer',
        category: 'Other',
        meta: 'Animate 2, 3, and 4-variable Karnaugh maps with minterms, dont cares, and Gray code ordering.',
        meta_bn: '2, 3, 4-variable Karnaugh map minterm, dont care এবং Gray code ordering সহ animation দেখুন।',
    },
    {
        id: 'ConvexHull',
        name: 'Convex Hull',
